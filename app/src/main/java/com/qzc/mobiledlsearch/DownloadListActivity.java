...
public class DownloadListActivity extends AppCompatActivity {
    public static void start(Context context, String tag) {
        Intent intent = new Intent(context, com.qzc.mobiledlsearch.DownloadListActivity.class);
            ...
            if (v == tvStatus) {
                switch (status) {
                    ...
                    case RUNNING:
                        ...
                        break;
                    case FINISHED:
                        String a = downloadInfo.getFilePath();
                        LogUtil.e("File Location: " + downloadInfo.getFilePath());
