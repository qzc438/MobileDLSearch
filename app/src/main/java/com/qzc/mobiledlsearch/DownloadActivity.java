...
public class DownloadActivity extends AppCompatActivity {
    ...
    private String url2 = "http://archive.ics.uci.edu/ml/machine-learning-databases/00240/UCI HAR Dataset.zip";
    //http://www.httpwatch.com/httpgallery/chunked/chunkedimage.aspx
    String url4 = "http://v.nq6.com/xinqu.apk";
    //    String url5 = "http://t2.hddhhn.com/uploads/tu/201612/98/st93.png";
    String url5 = "http://archive.ics.uci.edu/ml/machine-learning-databases/00240/UCI HAR Dataset.zip";
...
//        }
        ...
        findViewById(R.id.add_task).setOnClickListener(v -> {
            ...
            Pump.newRequest(downloadUrl)
                    ...
                    .listener(new DownloadListener(DownloadActivity.this) {
...
//                            APK.with(com.huxq17.download.demo.MainActivity.this)
//                                    .from(apkPath)
////                                        .forceInstall();
//                                    .install();
                            Toast.makeText(DownloadActivity.this, "Download Finished: " + getDownloadInfo().getFilePath(), Toast.LENGTH_SHORT).show();
                            LogUtil.e("Download Finished" + getDownloadInfo().getFilePath());
                        }
